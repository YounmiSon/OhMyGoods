...
const Login = () => {
  ...
  const loginBtn = () => {
    ...
    dispatch(login(inputs.email, inputs.password, nav));
  };
      ...
      <div className="flex flex-col justify-center items-center">
        <div className="bg-[#816bff]/50 w-96 h-96 rounded-xl mt-64 shadow-md">
          ...
          <div className="flex justify-center items-center mt-8">
            <input type="submit" value="로그인" onClick={loginBtn} className="bg-white cursor-pointer w-20 h-10 rounded-lg mr-4 hover:bg-[#816bff] hover:text-white" />
            <Link to="/join">
